...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Work_Manager</application>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Work_Item__c.Difficulty_Level__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Work_Item__c.End_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Work_Item__c.Estimated_Resolution_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Work_Item__c.Start_Date__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Work_Item__c-Work Item Action</layout>
        <recordType>Work_Item__c.Action_Work_Item</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Work_Item__c-Work Item Default</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Work_Item__c-Work Item Default</layout>
        <recordType>Work_Item__c.Work_Item</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Work_Item__c-Work Item Fix</layout>
        <recordType>Work_Item__c.Fix_Work_Item</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Work_Item__c-Work Item Idea</layout>
        <recordType>Work_Item__c.Idea_Work_Item</recordType>
    </layoutAssignments>
    <objectPermissions>
